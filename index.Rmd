...
author: "Alexis Naranjo"    # Autor del documento
...
<p style="text-align: justify;">Este informe explora el dataset penguins, el cual contiene información morfológica de pingüinos de tres especies que habitan distintas islas en la región Antártica. A partir de una limpieza y transformación inicial, se realizará un análisis gráfico y exploratorio, incluyendo visualizaciones en 3D para facilitar la identificación de patrones multivariados.</p>
